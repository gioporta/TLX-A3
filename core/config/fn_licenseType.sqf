...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "ins": {_var = "license_civ_ins"}; //Ins License
			...
			case "irf": {_var = "license_civ_irf"};
			case "alpha": {_var = "license_civ_alpha"};
			case "pmc": {_var = "license_civ_pmc"};
			case "aaa": {_var = "license_civ_aaa"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_ins": {_var = "ins"}; //Ins License
			...
			case "license_civ_irf": {_var = "irf"};
			case "license_civ_alpha": {_var = "alpha"};
			case "license_civ_pmc": {_var = "pmc"};
			case "license_civ_aaa": {_var = "aaa"};
			default {_var = ""};
		};
	};
};
