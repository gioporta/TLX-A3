...
class Life_Settings {
	...
	/* Impound Variables */
	impound_car = 1850; //Price for impounding cars
	impound_boat = 1850; //Price for impounding boats
	...
	"pickaxe","fuelEmpty", "fuelFull", "ziptie", "spikeStrip", "lockpick","boltCutter", "defuseKit", "redgull",
	...
	"mulletRaw", "catsharkRaw", "turtleRaw", "henRaw", "roosterRaw", "sheepRaw", "goatRaw", "zipties","gangplot","wall","slide","roadcone","bargate",
	"sandbag","guardpost","panicbutton","blindfold"
	};
};
...
class VirtualItems {
	...
	VITEMMACRO(blindfold, "STR_Item_blindfold", "blindfold", 3, 2500, -1, true, -1, "")
	...
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 12, -1, 22000, false, -1, "")
	...
	VITEMMACRO(panicbutton, "STR_Item_PanicButton", "panicbutton", 1, 200, -1, false, -1, "")
	VITEMMACRO(weddingring, "STR_Item_WeddingRing", "weddingring", 1, 2000, -1, false, -1, "")
	VITEMMACRO(condom, "STR_Item_Condom", "condom", 1, 120, -1, false, -1, "")
	VITEMMACRO(lollypop, "STR_Item_Lollypop", "lollypop", 1, 120, -1, false, -1, "")

	//Building
	VITEMMACRO(gangplot, "STR_Item_Gangplot", "gangplot", 3, 10000, -1, false, -1, "")
	VITEMMACRO(wall, "STR_Item_Wall", "wall", 1, 2500, -1, false, -1, "")
	VITEMMACRO(slide, "STR_Item_Slide", "slide", 1, 500, -1, false, -1, "")
	VITEMMACRO(bargate, "STR_Item_Bargate", "bargate", 2, 2500, -1, false, -1, "")
    VITEMMACRO(sandbag, "STR_Item_SandBag", "sandbag", 1, 1700, -1, false, -1, "")
    VITEMMACRO(guardpost, "STR_Item_GuardPost", "guardpost", 3, 6500, -1, false, -1, "")
	VITEMMACRO(roadcone, "STR_Item_RoadCone", "roadcone", 1, 250, -1, false, -1, "")
	
	//Alcohol
	VITEMMACRO(beer, "STR_Item_Beer", "beer", 1, 150, -1, false, -1, "")
	VITEMMACRO(whiskey, "STR_Item_Whiskey", "whiskey", 1, 220, -1, false, -1, "")
	VITEMMACRO(vodka, "STR_Item_Vodka", "vodka", 1, 210, -1, false, -1, "")
	
	//Drugfield
	VITEMMACRO(light, "STR_Item_Light", "light", 1, 150, -1, false, -1, "")
	VITEMMACRO(generator, "STR_Item_Generator", "generator", 1, 150, -1, false, -1, "")
	VITEMMACRO(netting, "STR_Item_Netting", "netting", 1, 200, -1, false, -1, "")
	VITEMMACRO(shovel, "STR_Item_Shovel", "shovel", 1, 55, -1, false, -1, "")
	VITEMMACRO(cannabisseed, "STR_Item_CannabisSeed", "cannabisseed", 1, 35, -1, false, -1, "")
	VITEMMACRO(cocaseed, "STR_Item_CocaSeed", "cocaseed", 1, 55, -1, false, -1, "")
	...
	VITEMMACRO(paintPink, "STR_Item_PaintPink", "paintPink", 1, 50000, 8000, false, -1, "")
	VITEMMACRO(paintCamo, "STR_Item_PaintCamo", "paintCamo", 1, 50000, 12000, false, -1, "")
	...
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 4000, false, -1, "")
	...
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 3, -1, 5750, true, -1, "")
	VITEMMACRO(morphine, "STR_Item_Morphine", "morphine", 4, -1, 4000, true, -1, "")
	VITEMMACRO(krokodil, "STR_Item_Krokodil", "krokodil", 4, -1, 5000, true, -1, "")
	VITEMMACRO(cannabis, "STR_Item_Cannabis", "cannabis", 3, -1, -1, true, -1, "")
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 2, -1, 6350, true, -1, "icons\ico_marijuana.paa")
	VITEMMACRO(hashish, "STR_Item_Hashish", "hashish", 3, -1, 6000, true, -1, "")
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 3, -1, 1500, true, -1, "")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 2, -1, 7750, true, -1, "")
	...
	//Food
	VITEMMACRO(apple, "STR_Item_Apple", "apple", 1, 100, 50, false, 10, "icons\peach.paa")
	...
	VITEMMACRO(salema_raw, "STR_Item_Salema", "salemaRaw", 2, -1, 45, false, -1, "icons\peach.paa")
	...
	//Uranium
	VITEMMACRO(uranium, "STR_Item_URANIUM", "uranium", 4, -1, -1, true, -1, "")
	VITEMMACRO(uraniumr, "STR_Item_URANIUMR", "uraniumr", 2, -1, 7400, false, -1, "")
};
...
*/
class Licenses {
	LICENSEMACRO(driver,"STR_License_Driver","driver",4000,false,"civ")
	LICENSEMACRO(boat,"STR_License_Boat","boat",2000,false,"civ")
	LICENSEMACRO(pilot,"STR_License_Pilot","pilot",25000,false,"civ")
	LICENSEMACRO(gun,"STR_License_Firearm","gun",12500,false,"civ")
	...
	LICENSEMACRO(passport,"STR_License_Passport","passport",3500,false,"civ")
...
class VirtualShops {
	...
	class ems {
		name = "STR_Shops_EMS";
		items[] = { "waterBottle", "rabbit_grilled", "apple","redgull", "fuelFull", "lockpick", "lollypop", "condom","gangplot","wall","sandbag","guardpost","slide","bargate","campfire","roadcone" };
	};
	...
	class oil {
		name = "STR_Shops_Oil";
		items[] = { "oil_processed","oil_diesel","oil_jet","oil_heavy", "pickaxe", "fuelFull" };
	};
	...
	class cop {
		name = "STR_Shops_Cop";
		items[] = { "panicbutton","spikeStrip", "waterBottle", "rabbit_grilled", "apple", "redgull", "fuelFull","defusekit","roadcone" };
	};
	...
	class building {
		name = "STR_Shops_Building";
		items[] = { "gangplot","wall","sandbag","guardpost","slide","bargate","roadcone" };
	};
